(** Abstraction Function: The piece [piece] contains information about the chess
    piece (its color, kind, and associated image). Representation invariant: the
    image should match the color and kind. *)
